...
import AdminItem from './AdminItem/AdminWaitItem';
    ...
    return (
        <div className='admin-list'>
            ...
            <div className='admin-list-header'>
                ...
                {/* <div className='admin-list-header-end'>
                    <button className='admin-list-button'>일괄 승인</button>
                    <button className='admin-list-button'>일괄 반려</button>
                </div> */}
            </div>
            ...
            <div className='admin-list-info'>
                ...
                <div className='admin-list-info-item-phone'>전화번호
                <img src={Arrow} /></div>
